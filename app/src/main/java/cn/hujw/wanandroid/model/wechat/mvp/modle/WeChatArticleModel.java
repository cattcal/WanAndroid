package cn.hujw.wanandroid.model.wechat.mvp.modle;
...
import cn.hujw.wanandroid.model.wechat.mvp.listener.WeChatArticleOnListener;
...
public class WeChatArticleModel extends MvpModel<WeChatArticleOnListener> {
    ...
    public void getSystemArticle(int id,int num) {
        // 为了省事，这里直接回调成功
        ApiHelper.getWanAndroidApi()
                .getWeChatArticle(id,num)
                .compose(Transformer.switchSchedulers())
                .subscribe(new DataObserver<WeChatArticleModel>() {
                    @Override
                    protected void onError(String errorMsg) {
                        getListener().onWeChatArticleFail(errorMsg);
                    }

                    @Override
                    protected void onSuccess(WeChatArticleModel data) {
                        getListener().onWeChatArticleSucceed(data);
                    }
                });
    }
    ...
    public static class DatasBean {
         ...
         * title : 滴滴的 “哆啦A梦” DoKit 背后的技术实现 1
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0
