package cn.hujw.wanandroid.model.wechat.adapter;
 ...
 */
public class WeChatArticleAdapter extends MyRecyclerViewAdapter<WeChatArticleModel.DatasBean> {

    public WeChatArticleAdapter(Context context) {
        super(context);
    }
